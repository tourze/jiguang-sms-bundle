...
use JiguangSmsBundle\Controller\Admin\VoiceCodeCrudController;
 ...
 * @internal
 */
#[CoversClass(VoiceCodeCrudController::class)]
#[RunTestsInSeparateProcesses]
final class VoiceCodeCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    /** @return VoiceCodeCrudController */
    protected function getControllerService(): AbstractCrudController
    {
        return self::getService(VoiceCodeCrudController::class);
    }
    ...
    public function testIndexPage(): void
    {
        ...
        // Navigate to VoiceCode CRUD
        $link = $crawler->filter('a[href*="VoiceCodeCrudController"]')->first();
        if ($link->count() > 0) {
    ...
    public function testDetailVoiceCode(): void
    {
    ...
    {
        $controller = new VoiceCodeCrudController();
        self::assertEquals(VoiceCode::class, $controller::getEntityFqcn());
    }
